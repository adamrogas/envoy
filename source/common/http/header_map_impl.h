...
#define DEFINE_REQUEST_HEADER_HANDLE(name)                                                         \
  Handle name = CustomInlineHeaderRegistry<RequestHeaderMap>::getInlineHeader(Headers::get().name);
...
#define DEFINE_RESPONSE_HEADER_HANDLE(name)                                                        \
  Handle name = CustomInlineHeaderRegistry<ResponseHeaderMap>::getInlineHeader(Headers::get().name);
